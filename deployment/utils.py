...
def generate_random_start(seed_length = 50, new_words = 50,
                          diversity = 1, return_output = False, n_gen = 1):
    """generate new words from a trained model and format into html"""
...
def generate_from_seed(seed, new_words=50, diversity=0.75):
